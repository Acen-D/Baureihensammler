...
object AlphaTrainSeriesRepository {
    val items: List<TrainSeries> = listOf(
        ...
        TrainSeries(
            ...
            aliases = listOf("146.3"),
        ),
        TrainSeries("146.5", "Traxx P160 AC2", "Elektrolokomotive", 160, 30, "Bombardier_Traxx", aliases = listOf("146")),
        TrainSeries(
            baureihe = "147",
            name = "TRAXX P160 AC3",
            category = "Lokomotive",
        ...
        TrainSeries(
            ...
            fleetEstimate = 80,
            wikiArticleTitle = "Bombardier_Traxx",
            aliases = listOf("185.1"),
        ),
        TrainSeries("185.2", "Bombardier Traxx 2 F140 AC2", "Elektrolokomotive", 140, 190, "Bombardier_Traxx"),
        TrainSeries(
            baureihe = "186",
            name = "Traxx F140 MS (2E)",
            category = "Elektrolokomotive",
            vmaxKmh = 160,
            fleetEstimate = 40,
            wikiArticleTitle = "Bombardier_Traxx",
        ...
        TrainSeries("245", "Traxx P160 DE ME", "Lokomotive", 160, 80, "Bombardier_Traxx"),
        TrainSeries("246", "Traxx P160 DE", "Diesellokomotive", 160, 20, "Bombardier_Traxx"),
        ...
        TrainSeries("285", "Traxx F140 DE", "Diesellokomotive", 140, 20, "Bombardier_Traxx"),
